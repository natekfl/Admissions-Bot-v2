...
module.exports = {
    ...
    setDiscordRankAdmissions: function (user, rankName) {
        ...
        switch (rankName) { //Add role ids to array
            ...
            case "Labour Lottery ":
                roleIds.push(idvariables.rankRoles.inspectorInTraining);
                break;
            case "Inspector in Training":
                roleIds.push(idvariables.rankRoles.inspectorInTraining, idvariables.miscRoles.boothOp);
                break;
            ...
            case "Inspector":
                ...
                break;
            case "Junior Officer":
                roleIds.push(idvariables.rankRoles.juniorOfficer, idvariables.miscRoles.boothOp, idvariables.miscRoles.staff, idvariables.miscRoles.trainer);
                break;
            case "Senior Officer":
                roleIds.push(idvariables.rankRoles.seniorOfficer, idvariables.miscRoles.boothOp, idvariables.miscRoles.staff, idvariables.miscRoles.trainer);
                break;
            case "Commissioner":
                roleIds.push(idvariables.rankRoles.commissioner, idvariables.miscRoles.serverMod, idvariables.miscRoles.staff, idvariables.miscRoles.trainer);
                break;
            default:
                return false;
        }
