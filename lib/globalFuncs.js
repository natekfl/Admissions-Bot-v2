    ...
    setDiscordRankAdmissions: function (user, rankName) {
        ...
        switch (rankName) { //Add role ids to array
            ...
            case "Junior Inspector":
                ...
                break;
            case "Senior Inpsector":
                roleIds.push(idvariables.rankRoles.senior, idvariables.miscRoles.boothOp);
                break;
            case "Head Inspector":
                roleIds.push(idvariables.rankRoles.head, idvariables.miscRoles.boothOp, idvariables.miscRoles.staff);
                break;
            case "Junior Supervisor":
                roleIds.push(idvariables.rankRoles.juniorSupervisor, idvariables.miscRoles.boothOp, idvariables.miscRoles.staff);
                break;
            case "Supervisor":
                roleIds.push(idvariables.rankRoles.supervisor, idvariables.miscRoles.serverMod, idvariables.miscRoles.staff);
                break;
			case "Chief Inspector":
                roleIds.push(idvariables.rankRoles.chief, idvariables.miscRoles.serverMod, idvariables.miscRoles.staff);
                break;
            default:
                return false;
        }
