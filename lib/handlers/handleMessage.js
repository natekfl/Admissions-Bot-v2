...
let commands = {
    ...
    "!voidcitation": {
        ...
        "description": "Voids the specified citation",
        "perm": 8,
        "func": function (message) {
            let args = message.content.split(" ");
    ...
    "!endsuspension": {
        ...
        "description": "Ends a suspension. Can only be used by Supervisor+",
        "perm": 9,
        "func": function (message) {
            let args = message.content.split(" ");
            if (args.length !== 2) return false;
    ...
    "!approve": {
        "usage": "!approve [@user]",
        "description": "Approves a user to take the Inspector Trial. Can only be used by Senior Inspector+",
        "perm": 6,
        "func": function (message) {
            let args = message.content.split(" ");
            if (args.length < 2) return false;
    ...
    "!approvedlist": {
        "usage": "!approvedlist",
        "description": "Shows the list of users approved to take the Inspector Trial, from oldest to Newest. Can only be used by Head Inspector+",
        "perm": 7,
        "func": function (message) {
            //Command is correct
